import Bybit from './connector/spotExchanges/Bybit.js';
import BybitPerp from './connector/futuresExchanges/BybitPerp.js';
...
const DEFAULT_OUTPUT_FILE = './data/bybit_btc_funding_rate_history.csv';

// Interval configuration - aligned with funding periods
// Bybit funding period = 8 hours
...
async function collectFundingRateHistory() {
    ...
    console.log('═══════════════════════════════════════════════════════════════');
    console.log('  Bybit BTC Funding Rate History Collection');
    console.log('═══════════════════════════════════════════════════════════════');
    ...
    const spotClient = new Bybit('', '');
    const futuresClient = new BybitPerp('', '');

    // Initialize FundingRateHistory
    const frh = new FundingRateHistory(spotClient, futuresClient, db);
